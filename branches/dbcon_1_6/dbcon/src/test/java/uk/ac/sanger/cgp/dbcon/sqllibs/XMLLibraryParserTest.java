...
/**
 * Tests that the XML library format is behaving as advertised
 *
 * @author Andy Yates
 * @author $Author: ady $
 * @version $Revision: 1.2 $
 */
public class XMLLibraryParserTest extends LibraryAbstractTestCase {
	
	public XMLLibraryParserTest(String testName) {
		super(testName, Constants.XML_LIB_RESOURCE);
	}
